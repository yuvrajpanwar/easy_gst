<?php
  ...
  function warning()
  {
    ...
    $differenceInSeconds = strtotime($to_date) - strtotime($today);
  ...
  function is_order($product_id,$order_products)
  {
  ...
  function is_5gst($order_products)
  {
    $gst_amount = 0;
    foreach($order_products as $item)
    {

      if($item->cgst_tax == 2.5)
      {
        $gst_amount = $item->cgst_amount + $item->sgst_amount;
      }
  ...
  function is_18gst($order_products)
  {
    $gst_amount = 0;
    foreach($order_products as $item)
    {
