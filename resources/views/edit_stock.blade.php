...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><i class="fa fa-plus-square"></i> Edit Stock
        ...
        <form id="form" action="{{route('update_stock',['id'=>$stock->id])}}" method="post" enctype="multipart/form-data" class="form-horizontal">
            @csrf
            <div class="row">
                <div class="col-md-9">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <select data-placeholder="Choose a country..." name="prid" id="prid"
                                        ...
                                        @foreach ($products as $product)
                                            <option value="{{$product->id}}" {{($product->id==$stock->product_id)?'selected':''}}>{{$product->title}}</option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="in_number" id="in_number" value="{{$stock->invoice_number}}"/>
                                </div>
                                <div class="col-lg-4">
                                    <label>Invoice Date</label>
                                    <input type="text" class="form-control datepicker" name="invoice_date"
                                        id="invoice_date" value="{{$stock->invoice_date}}"/>
                                </div>
                                <div class="col-lg-4">
                                    <label>Party Name</label>
                                    <input type="text" class="form-control" name="name" id="name" value="{{$stock->vendor_name}}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    <label>Qty</label>
                                    <input type="number" class="form-control" name="gmqty" id="gmqty" value="{{$stock->gmqty}}"/>
                                </div>
                                <div class="col-lg-2">
                                    <label>Unit</label>
