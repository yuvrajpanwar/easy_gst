                                                ...
                                                <table class="table table-striped table-bordered table-hover" id="">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <input type='checkbox' name='pro_name[]'
                                                                    class='contact_check roles' id="product-1"
                                                                    value='21'> Aaaaaaaaaaaa
                                                            </td>

                                                            <td>
                                                                <label id="price_lb-1">345345.00</label>
                                                                
                                                            </td>

                                                            <td>
                                                                <label id="cgst_lb-1">13813.8</label>
                                                                
                                                            </td>

                                                            <td>
                                                                <label id="sgst_lb-1">13813.8</label>
                                                            
                                                            </td>

                                                            <td>
                                                                <label id="total_amount_lb-1">372972.6</label>
                                                            
                                                            </td>

                                                            <td>
                                                            
                                                                <select name="21" class="total_pices total_pices-21"
                                                                    id="total_pices-1">
                                                                    <option value='1'>1</option>
                                                                    <option value='2'>2</option>
                                                                    <option value='3'>3</option>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <input type='checkbox' name='pro_name[]'
                                                                    class='contact_check roles' id="product-2"
                                                                    value='28'> Dfgdfdgdg
                                                            </td>

                                                            <td>
                                                                <label id="price_lb-2">4.00</label>
                                                            
                                                            </td>

                                                            <td>
                                                                <label id="cgst_lb-2">0.16</label>
                                                            
                                                            </td>

                                                            <td>
                                                                <label id="sgst_lb-2">0.16</label>
                                                            
                                                            </td>

                                                            <td>
                                                                <label id="total_amount_lb-2">4.32</label>
                                                            
                                                            </td>

                                                            <td>
                                                            
                                                                <select name="28" class="total_pices total_pices-28"
                                                                    id="total_pices-2">
                                                                    <option value='1'>1</option>
                                                                    <option value='2'>2</option>
                                                                    <option value='3'>3</option>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <input type='checkbox' name='pro_name[]'
                                                                    class='contact_check roles' id="product-3"
                                                                    value='27'> Ryfhtgcvfh
                                                            </td>

                                                            <td>
                                                                <label id="price_lb-3">4.00</label>
                                                                
                                                            </td>

                                                            <td>
                                                                <label id="cgst_lb-3">0.16</label>
                                                            
                                                            </td>

                                                            <td>
                                                                <label id="sgst_lb-3">0.16</label>
                                                            
                                                            </td>

                                                            <td>
                                                                <label id="total_amount_lb-3">4.32</label>
                                                                
                                                            </td>

                                                            <td>
                                                            
                                                                <select name="27" class="total_pices total_pices-27"
                                                                    id="total_pices-3">
                                                                    <option value='1'>1</option>
                                                                    <option value='2'>2</option>
                                                                    <option value='3'>3</option>
